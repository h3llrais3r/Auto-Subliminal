...
|   `-- urllib3 >=1.21.1,<3 
`-- simplejson *
dogpile-cache 1.4.0 A caching front-end based on the Dogpile lock.
|-- decorator >=4.0.0
|-- stevedore >=3.0.0
|   `-- pbr >=2.0.0 
`-- typing-extensions >=4.0.1
enzyme 0.5.2 Video metadata parser
ffsubsync 0.4.29 Language-agnostic synchronization of subtitles with video.
|-- auditok 0.1.5
|-- chardet *
|-- charset-normalizer *
|-- faust-cchardet *
...
|-- trans >=2.1.0
`-- wheel >=0.38.0
jsonpickle 4.0.5 jsonpickle encodes/decodes any Python object to/from JSON
