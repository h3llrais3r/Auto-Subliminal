...
|-- webrtcvad *
`-- webrtcvad-wheels *
gitpython 3.1.47 GitPython is a Python library used to interact with Git repositories
`-- gitdb >=4.0.1,<5
    `-- smmap >=3.0.1,<6 
...
|-- six >=1.9
`-- webencodings *
imdbinfo 0.8.3 A Python service for querying IMDb data
|-- cryptography *
|   |-- cffi >=2.0.0 
|   |   `-- pycparser * 
...
`-- six *
packaging 26.1 Core utilities for Python packages
...
simplejson 4.0.1 Simple, fast, extensible JSON encoder/decoder for Python
