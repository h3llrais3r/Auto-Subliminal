...
|   `-- urllib3 >=1.21.1,<3 
`-- simplejson *
dogpile-cache 1.3.2 A caching front-end based on the Dogpile lock.
|-- decorator >=4.0.0
|-- stevedore >=3.0.0
...
|-- webrtcvad *
`-- webrtcvad-wheels *
gitpython 3.1.42 GitPython is a Python library used to interact with Git repositories
`-- gitdb >=4.0.1,<5
    `-- smmap >=3.0.1,<6 
...
|-- trans >=2.1.0
`-- wheel >=0.38.0
jsonpickle 3.0.3 Python library for serializing any arbitrary object graph into JSON
...
|-- idna >=2.5,<4
`-- urllib3 >=1.21.1,<3
requests-oauthlib 1.4.0 OAuthlib authentication support for Requests.
|-- oauthlib >=3.0.0
`-- requests >=2.0.0
    |-- certifi >=2017.4.17 
    |-- charset-normalizer >=2,<4 
