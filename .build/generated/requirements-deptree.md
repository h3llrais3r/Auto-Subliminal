...
|-- typing-extensions *
`-- webrtcvad-wheels *
gitpython 3.1.51 GitPython is a Python library used to interact with Git repositories
`-- gitdb >=4.0.1,<5
    `-- smmap >=3.0.1,<6 
...
|-- six >=1.9
`-- webencodings *
imdbinfo 0.9.1 A Python service for querying IMDb data
|-- deprecated *
|   `-- wrapt >=1.10,<3 
|-- imdbinfo-aws *
|   |-- cryptography >=41 
...
simplejson 4.1.1 Simple, fast, extensible JSON encoder/decoder for Python
stevedore 5.8.0 Manage dynamic plugins for Python applications
...
|-- six >=1.10.0
`-- urllib3 >=1.15.1
unidecode 1.4.0 ASCII transliterations of Unicode text
ws4py 0.6.0 WebSocket client and server library for Python 2 and 3 as well as PyPy
```
