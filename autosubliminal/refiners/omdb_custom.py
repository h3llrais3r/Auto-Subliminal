...
class OMDBClient(object):
    ...
    def __init__(self, version=1, session=None, headers=None, timeout=10):
        ...
        self.session.params['apikey'] = 'REPLACE_ME'
...
def refine(video, **kwargs):
    ...
    # exit if no apikey is provided
    if not autosubliminal.OMDBAPIKEY:
        return

    # add apikey to omdb client
    omdb_client.session.params['apikey'] = autosubliminal.OMDBAPIKEY
