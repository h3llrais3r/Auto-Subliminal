...
def initialize():
    global CONFIGFILE, CONFIGVERSION, CONFIGUPGRADED, \
        ...
        THREADS, SCANDISK, CHECKSUB, CHECKVERSION, \
        DBFILE, DBVERSION, \
        DAEMON, STARTED, PID, \
        ...
        SCHEDULERSCANDISK, SCHEDULERCHECKSUB, SCHEDULERCHECKVERSION, SCANEMBEDDEDSUBS, SKIPHIDDENDIRS, MAXDBRESULTS, \
