...
def initialize():
    global CONFIGFILE, CONFIGVERSION, CONFIGUPGRADED, \
        ...
        PATH, VIDEOPATHS, DEFAULTLANGUAGE, DEFAULTLANGUAGESUFFIX, ADDITIONALLANGUAGES, SCANDISK, CHECKSUB, \
        ...
        SHOWMINMATCHSCORE, SHOWMINMATCHSCOREDEFAULT, MOVIEMINMATCHSCORE, MOVIEMINMATCHSCOREDEFAULT, \
        MATCHSOURCE, MATCHQUALITY, MATCHCODEC, MATCHRELEASEGROUP, \
