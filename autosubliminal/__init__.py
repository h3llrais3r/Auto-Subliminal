...
# Addic7ed shownamemapping config section
...
def initialize():
    global CONFIGFILE, CONFIGVERSION, CONFIGUPGRADED, \
        ...
        ADDIC7EDSHOWNAMEMAPPING, USERSHOWNAMEMAPPING, USERSHOWNAMEMAPPINGUPPER, \
        USERMOVIENAMEMAPPING, USERMOVIENAMEMAPPINGUPPER, \
        ...
        NOTIFYGROWL, GROWLHOST, GROWLPASS, NOTIFYPROWL, PROWLAPI, PROWLPRIORITY, \
