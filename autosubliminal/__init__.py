...
def initialize():
    global CONFIGFILE, CONFIGVERSION, CONFIGUPGRADED, \
        ...
        MINMATCHSCOREDEFAULT, MATCHSOURCE, MATCHQUALITY, MATCHCODEC, MATCHRELEASEGROUP, NOTIFY, SCANDISK, CHECKSUB, \
        ...
        SUBLIMINALPROVIDERS, SUBLIMINALPROVIDERLIST, INCLUDEHEARINGIMPAIRED, \
