...
from autosubliminal.providers.proxy import Proxy
...
class Pitcher(ABC):
    ...
    def __init__(self, website_name, website_url, website_key, tries=3, client_key=None, *args, **kwargs):
        self.tries = tries
        self.client_key = client_key or autosubliminal.ANTICAPTCHACLIENTKEY
...
class PitcherRegistry(object):
    ...
    def get_pitcher(self, name_or_site=None, with_proxy=False):
        name_or_site = name_or_site or autosubliminal.ANTICAPTCHACLASS
        if not name_or_site:
