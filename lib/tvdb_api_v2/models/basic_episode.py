...
class BasicEpisode(object):
    ...
    def __init__(self, absolute_number=None, aired_episode_number=None, aired_season=None, dvd_episode_number=None, dvd_season=None, episode_name=None, first_aired=None, id=None, language=None, last_updated=None, overview=None):
        """
    ...
    def language(self):
        """
        Gets the language of this BasicEpisode.

        :return: The language of this BasicEpisode.
    ...
    def language(self, language):
        ...
        :param language: The language of this BasicEpisode.
