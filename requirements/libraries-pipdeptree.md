...
``` 
CherryPy==17.4.2
  - cheroot [required: >=6.2.4, installed: 8.4.5]
    - jaraco.functools [required: Any, installed: 2.0]
      - more-itertools [required: Any, installed: 5.0.0]
        - six [required: >=1.0.0,<2.0.0, installed: 1.15.0]
    - more-itertools [required: >=2.6, installed: 5.0.0]
      - six [required: >=1.0.0,<2.0.0, installed: 1.15.0]
    - six [required: >=1.11.0, installed: 1.15.0]
  - contextlib2 [required: Any, installed: 0.5.5]
  - more-itertools [required: Any, installed: 5.0.0]
    - six [required: >=1.0.0,<2.0.0, installed: 1.15.0]
  - portend [required: >=2.1.1, installed: 2.6]
    - tempora [required: >=1.8, installed: 1.14.1]
      - jaraco.functools [required: >=1.20, installed: 2.0]
        - more-itertools [required: Any, installed: 5.0.0]
          - six [required: >=1.0.0,<2.0.0, installed: 1.15.0]
...
subliminal==2.1.0.dev0
  ...
  - pytz [required: >=2012c, installed: 2020.5]
