  ...
  - jaraco.collections [required: Any, installed: 3.3.0]
    ...
    - jaraco.text [required: Any, installed: 3.5.0]
      - importlib-resources [required: Any, installed: 5.1.2]
        - zipp [required: >=0.4, installed: 3.5.0]
      - jaraco.functools [required: Any, installed: 3.3.0]
        - more-itertools [required: Any, installed: 8.7.0]
  - more-itertools [required: Any, installed: 8.7.0]
...
jsonpickle==2.0.0
  - importlib-metadata [required: Any, installed: 3.10.1]
...
python-twitter==3.5
  ...
  - requests-oauthlib [required: Any, installed: 1.3.0]
    ...
    - requests [required: >=2.0.0, installed: 2.25.1]
      ...
      - urllib3 [required: >=1.21.1,<1.27, installed: 1.26.4]
schema==0.7.4
  - contextlib2 [required: >=0.5.5, installed: 0.6.0.post1]
subliminal==2.1.0.dev0
  ...
  - dogpile.cache [required: >=0.6.0, installed: 1.1.2]
    - decorator [required: >=4.0.0, installed: 5.0.9]
    - stevedore [required: >=3.0.0, installed: 3.3.0]
      - importlib-metadata [required: >=1.7.0, installed: 3.10.1]
        - typing-extensions [required: >=3.6.4, installed: 3.10.0.0]
        - zipp [required: >=0.5, installed: 3.5.0]
