...
/* harmony import */ var _models_systeminfo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../models/systeminfo */ 8435);
    ...
    ngOnInit() {
      ...
      this.systemService.getSystemInfo().pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_5__.takeUntilDestroyed)(this.destroyRef)).subscribe({
        next: systemInfo => {
          ...
          if (this.systemInfo.installType === _models_systeminfo__WEBPACK_IMPORTED_MODULE_2__.SystemInstallType.SOURCE) {
            this.version = this.systemInfo.currentVersion;
            this.versionUrl = this.systemInfo.currentVersionUrl;
          } else if (this.systemInfo.installType === _models_systeminfo__WEBPACK_IMPORTED_MODULE_2__.SystemInstallType.GIT) {
...
//# sourceMappingURL=448.508240a59af6d49f.js.map