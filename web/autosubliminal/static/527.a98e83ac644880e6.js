"use strict";
(self["webpackChunkautosubliminal"] = self["webpackChunkautosubliminal"] || []).push([[527],{
...
/* harmony import */ var _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/utils/string-utils */ 672);
/* harmony import */ var _shared_utils_table_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/utils/table-utils */ 981);
...
let HomeDownloadedComponent = /*#__PURE__*/(() => {
  class HomeDownloadedComponent {
    ...
    buildSelectItems() {
      ...
      Object.values(_shared_models_video__WEBPACK_IMPORTED_MODULE_2__.VideoType).forEach(videoType => this.videoTypes.push({
  ...
  HomeDownloadedComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.NgIf, primeng_api__WEBPACK_IMPORTED_MODULE_10__.PrimeTemplate, primeng_table__WEBPACK_IMPORTED_MODULE_11__.Table, primeng_table__WEBPACK_IMPORTED_MODULE_11__.SortableColumn, primeng_table__WEBPACK_IMPORTED_MODULE_11__.SortIcon, primeng_dropdown__WEBPACK_IMPORTED_MODULE_12__.Dropdown, _shared_components_icon_dropdown_icon_dropdown_component__WEBPACK_IMPORTED_MODULE_5__.IconDropdownComponent, _shared_components_table_filter_table_filter_component__WEBPACK_IMPORTED_MODULE_6__.TableFilterComponent],
...
/* harmony import */ var _wanted_home_wanted_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./wanted/home-wanted.component */ 4822);
/* harmony import */ var _downloaded_home_downloaded_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./downloaded/home-downloaded.component */ 6877);
...
/* harmony import */ var _downloaded_home_downloaded_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./downloaded/home-downloaded.component */ 6877);
/* harmony import */ var _home_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./home-routing.module */ 8934);
/* harmony import */ var _home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./home.component */ 4269);
/* harmony import */ var _search_home_search_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./search/home-search.component */ 410);
/* harmony import */ var _wanted_home_wanted_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./wanted/home-wanted.component */ 4822);
...
/* harmony import */ var _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/utils/number-utils */ 1264);
/* harmony import */ var _shared_utils_path_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../shared/utils/path-utils */ 9455);
...
/* harmony import */ var _shared_components_loading_loading_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../shared/components/loading/loading.component */ 6992);
/* harmony import */ var _shared_components_message_message_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../shared/components/message/message.component */ 6325);
  ...
  class HomeSearchComponent {
    ...
    ngOnInit() {
      ...
      this.route.queryParamMap.pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_12__.takeUntilDestroyed)(this.destroyRef)).subscribe({
        next: queryParamMap => {
          const wantedItemId = (0,_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_4__.toNumber)(queryParamMap.get('wantedItemId'));
    ...
    getWebsiteUrl(subtitle) {
      return (0,_shared_utils_common_utils__WEBPACK_IMPORTED_MODULE_3__.getDereferUrl)(subtitle.pageLink);
    }
    ...
    syncSubtitle() {
      this.subtitleSyncVideoPath = (0,_shared_utils_path_utils__WEBPACK_IMPORTED_MODULE_5__.joinPaths)(this.wantedItem.videoFilePath, this.wantedItem.videoFileName);
      this.subtitleSyncSubtitlePath = this.savedSubtitle.subtitlePath;
      this.showSubtitleSyncDialog = true;
    }
    getPlayVideoUrl() {
      return this.domSanitizer.bypassSecurityTrustResourceUrl((0,_shared_utils_common_utils__WEBPACK_IMPORTED_MODULE_3__.getPlayVideoUrl)(this.wantedItem.videoFilePath, this.wantedItem.videoFileName));
    }
...
/* harmony import */ var _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../shared/utils/string-utils */ 672);
...
/* harmony import */ var primeng_dropdown__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! primeng/dropdown */ 4553);
/* harmony import */ var primeng_confirmdialog__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! primeng/confirmdialog */ 4123);
/* harmony import */ var _shared_components_icon_dropdown_icon_dropdown_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/components/icon-dropdown/icon-dropdown.component */ 8870);
/* harmony import */ var _shared_components_table_filter_table_filter_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../shared/components/table-filter/table-filter.component */ 4610);
/* harmony import */ var _shared_components_movie_settings_movie_settings_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../shared/components/movie-settings/movie-settings.component */ 4068);
/* harmony import */ var _shared_components_show_settings_show_settings_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../shared/components/show-settings/show-settings.component */ 2827);
/* harmony import */ var _shared_components_manual_refine_manual_refine_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../shared/components/manual-refine/manual-refine.component */ 3481);
...
let HomeWantedComponent = /*#__PURE__*/(() => {
  class HomeWantedComponent {
    ...
    displayUpperCase(value) {
      return (0,_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_6__.displayValue)(value, 'N/A', true);
    }
    getTvdbUrl(wantedItem) {
      return (0,_shared_utils_common_utils__WEBPACK_IMPORTED_MODULE_5__.getTvdbUrl)(wantedItem.tvdbId);
    }
    getImdbUrl(wantedItem) {
      return (0,_shared_utils_common_utils__WEBPACK_IMPORTED_MODULE_5__.getImdbUrl)(wantedItem.imdbId);
    }
    searchIndexerId(wantedItem) {
      ...
      this.itemService.searchWantedItemIndexerId(wantedItem.id).pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_16__.takeUntilDestroyed)(this.destroyRef)).subscribe({
        next: updatedWantedItem => {
          ...
          this.messageService.showSuccessMessage(`${(0,_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_6__.capitalizeFirstChar)(indexer)} found for ${updatedWantedItem.longName}.`);
        },
    ...
    buildSelectItems() {
      ...
      Object.values(_shared_models_video__WEBPACK_IMPORTED_MODULE_4__.VideoType).forEach(videoType => this.videoTypes.push({
        label: (0,_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_6__.capitalizeFirstChar)(videoType),
        value: videoType
      }));
    }
    loadWantedItems() {
  ...
  HomeWantedComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_17__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_17__.NgIf, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.NgModel, primeng_api__WEBPACK_IMPORTED_MODULE_15__.Footer, primeng_api__WEBPACK_IMPORTED_MODULE_15__.PrimeTemplate, primeng_table__WEBPACK_IMPORTED_MODULE_19__.Table, primeng_table__WEBPACK_IMPORTED_MODULE_19__.SortableColumn, primeng_table__WEBPACK_IMPORTED_MODULE_19__.SortIcon, primeng_button__WEBPACK_IMPORTED_MODULE_20__.ButtonDirective, primeng_inputtext__WEBPACK_IMPORTED_MODULE_21__.InputText, primeng_inputswitch__WEBPACK_IMPORTED_MODULE_22__.InputSwitch, primeng_dropdown__WEBPACK_IMPORTED_MODULE_23__.Dropdown, primeng_confirmdialog__WEBPACK_IMPORTED_MODULE_24__.ConfirmDialog, _shared_components_icon_dropdown_icon_dropdown_component__WEBPACK_IMPORTED_MODULE_8__.IconDropdownComponent, _shared_components_table_filter_table_filter_component__WEBPACK_IMPORTED_MODULE_9__.TableFilterComponent, _shared_components_movie_settings_movie_settings_component__WEBPACK_IMPORTED_MODULE_10__.MovieSettingsComponent, _shared_components_show_settings_show_settings_component__WEBPACK_IMPORTED_MODULE_11__.ShowSettingsComponent, _shared_components_manual_refine_manual_refine_component__WEBPACK_IMPORTED_MODULE_12__.ManualRefineComponent],
...
//# sourceMappingURL=527.a98e83ac644880e6.js.map