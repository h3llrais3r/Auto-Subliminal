    ...
    <div class="modal-dialog settings-modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title">Show/Movie settings</h3>
            </div>

            <div v-if="settings" class="modal-body">
                <div class="settings-container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="settings-poster-container" v-lazy-container>
                                <img id ="settingsPosterImage" class="settings-poster-image" :key="posterThumbnailUrl" :data-src="posterThumbnailUrl" :data-loading="posterPlaceholderUrl" :data-error="posterPlaceholderUrl">
                            </div>
                                ...
                                <div class="col-xs-12 settings-info-settings">
                                    <div class="vertical-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <label class="switch-checkbox pull-right">
                                                    <input type="checkbox" id="hearingImpairedSwitch" v-model="settings.hearingImpaired">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <label class="switch-checkbox pull-right">
                                                    <input type="checkbox" id="utf8EncodingSwitch" v-model="settings.utf8Encoding">
