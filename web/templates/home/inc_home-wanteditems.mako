                    ...
                    <tbody>
                        % for index, item in enumerate(autosubliminal.WANTEDQUEUE):
                            <tr class="wanted-item">
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body text-right">
                                                            <div class="form-inline form-group narrow">
                                                                ...
                                                                <input type="text" value="${item['title']}" class="form-control input-sm update-wanted-item-title">
                                                            </div>
                                                            <div class="form-inline form-group narrow">
                                                                <span class="info-list-label">Year:</span>
                                                                <input type="text" value="${item['year']}" class="form-control input-sm update-wanted-item-year">
                                                            </div>
                                                            <div class="form-inline form-group narrow">
                                                                <span class="info-list-label">Season:</span>
                                                                <input type="text" value="${item['season']}" class="form-control input-sm update-wanted-item-season">
                                                            </div>
                                                            <div class="form-inline form-group narrow">
                                                                <span class="info-list-label">Episode:</span>
                                                                <input type="text" value="${item['episode']}" class="form-control input-sm update-wanted-item-episode">
                                                            </div>
                                                            <div class="form-inline form-group narrow">
                                                                <span class="info-list-label">Source:</span>
                                                                <input type="text" value="${item['source']}" class="form-control input-sm update-wanted-item-source">
                                                            </div>
                                                            <div class="form-inline form-group narrow">
                                                                <span class="info-list-label">Quality:</span>
                                                                <input type="text" value="${item['quality']}" class="form-control input-sm update-wanted-item-quality">
                                                            </div>
                                                            <div class="form-inline form-group narrow">
                                                                <span class="info-list-label">Codec:</span>
                                                                <input type="text" value="${item['codec']}" class="form-control input-sm update-wanted-item-codec">
                                                            </div>
                                                            <div class="form-inline form-group narrow">
                                                                <span class="info-list-label">Group:</span>
                                                                <input type="text" value="${item['releasegrp']}" class="form-control input-sm update-wanted-item-releasegrp">
                                                            </div>
                                ...
                                <td class="wanted-item-season">${item['season']}</td>
                                <td class="wanted-item-episode">${item['episode']}</td>
