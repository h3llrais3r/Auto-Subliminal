                                ...
                                <div class="col-xs-12">
                                    <div class="details-poster-container" v-lazy-container>
                                        <a :href="moviePosterFullSizeUrl" target="_blank">
                                            <img class="details-poster-image" :key="moviePosterThumbnailUrl" :data-src="moviePosterThumbnailUrl" :data-loading="posterPlaceholderUrl" :data-error="posterPlaceholderUrl">
                                        </a>
                                    </div>
