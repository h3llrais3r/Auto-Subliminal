                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="settings-poster-container" v-lazy-container>
                                <img class="settings-poster-image" :key="showPosterThumbnailUrl" :data-src="showPosterThumbnailUrl" :data-loading="posterPlaceholderUrl" :data-error="posterPlaceholderUrl">
                            </div>
                                ...
                                <div class="col-xs-12 settings-info-settings">
                                    <div class="vertical-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <label class="switch-checkbox pull-right">
                                                    <input type="checkbox" id="hearingImpairedSwitch" v-model="showSettings.hearingImpaired">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <label class="switch-checkbox pull-right">
                                                    <input type="checkbox" id="utf8EncodingSwitch" v-model="showSettings.utf8Encoding">
