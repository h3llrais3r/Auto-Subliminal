...
def test_get_libraries(monkeypatch: MonkeyPatch):
...
def test_get_library_version(monkeypatch: MonkeyPatch):
    monkeypatch.setattr('autosubliminal.util.packaging.REQUIREMENTS_FILE', libraries_file)
...
def test_get_library_version_error(monkeypatch: MonkeyPatch):
    monkeypatch.setattr('autosubliminal.util.packaging.REQUIREMENTS_FILE', libraries_file)
