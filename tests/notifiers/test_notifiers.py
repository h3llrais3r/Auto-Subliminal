...
def test_notifiers_notify(mocker: MockerFixture):
...
def test_notifiers_notify_download(mocker: MockerFixture):
...
def test_notifiers_test_notifier(mocker: MockerFixture):
