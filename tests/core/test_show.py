...
def test_get_artwork_url():
    ...
    show_details = ShowDetails(path='/path/to/show', tvdb_id=80379, title='The Big Bang Theory', year=2007,
                               overview='overview', poster='posters/80379-18.jpg', banner='graphical/80379-g13.jpg')
